...
public:
    ...
    // Individual response matrix for theta, phi, and detector ID
    TH3D * individualresponse = new TH3D("individualresponse", "individualresponse", 61, -30.5, 30.5, 61, -30.5, 30.5, 64, 0.5, 64.5);
    inline TH3D * GetIndividualResponseHist(){return individualresponse;}
    inline void ClearIndividualResponseHist(){individualresponse->Reset();}
